...
- [x] **空のチェック項目のバックスペースでチェックボックスが外れる**: 「- [ ] 」の変換直後などの本文が空のチェックリスト項目でバックスペースを押すと、チェックボックスが外れて空の段落に戻り、そのまま続きを入力できる。本文のある項目や日本語入力の変換中は通常の文字削除のまま (issue #108)
  - 自動化: NikkiTests/BlockEditingTests.swift (exitsChecklistOnBackspaceAtEmptyItem / exitsChecklistOnBackspaceAtEmptyDoneItem / splitsChecklistOnBackspaceAtEmptyMiddleItem / keepsChecklistOnBackspaceAtNonEmptyItem) + manual（キー入力の経路がプラットフォームで異なるため実キーボード入力で確認する）
  - 2026-08-25 macOS (署名なし Debug + カタログ entryList) で「- [ ] 」からチェックボックスを作り (https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/b58f8f3c-b156-4731-b679-96265baf708f.png)、バックスペース1回でチェックボックスが消えて空の段落に戻り (https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/7323b245-b1c9-43fb-a725-0c244b5b85aa.png)、そのまま「after ok」を続けて入力できた (https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/0979ca62-b700-4c41-ad21-025c2341d163.png)
  - 2026-08-25 macOS の日本語入力 (Kotoeri ローマ字) で、空の項目に変換中テキスト「ka」がある状態 (https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/ed22fb5a-809b-47b2-8d5d-7d136571595d.png) のバックスペースは変換中テキストの編集 (「ka」→「k」) になり、チェックボックスは残った (変換中にブロックが壊れない。 https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/4d372fa6-2468-4d7c-bbf9-21d5b1656fca.png)
  - 2026-08-25 iOS (simtunnel リモート iOS Simulator、カタログ entryList): ソフトウェアキーボードで「- [ ] 」からチェックボックスが作られ (https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/274586e1-759c-4e42-a71a-caea3c054276.jpg)、画面上の ⌫ ではチェックボックスは消えない (ソフトウェアキーボードのバックスペースはキー入力として届かない既知の制限。 https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/96a1c42a-ec09-4a91-b083-3fffbb0d06d5.jpg)。空の項目の Return でリストから抜けて段落に戻る既存経路は動作した (https://pub-7f3469dd3e2e445b9b8ec2d1381b5ea8.r2.dev/bannzai/nikki/20260825/68961530-0b9a-4457-a316-f1ddebd2176c.jpg)
  - iOS のハードウェアキーボードのバックスペース (EditorChecklistField の onKeyPress 経路) は未検証: simtunnel の WDA (XCTest typeText) が送る backspace はテキスト入力システム経由で onKeyPress に届かず、実ハードウェアキーボード相当のキーイベントを送る手段がないため (WDA の backspace ではチェックボックスは消えないことを確認済み)
